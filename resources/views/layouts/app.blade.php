    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <ul class="d-lg-flex d-none">
                <li><a @if(request()->routeIs('home')) class="active" @endif href="{{route('home')}}">Главная</a></li>
                <li><a @if(request()->routeIs('about')) class="active" @endif href="{{route('about')}}">О компании</a></li>
                <li><a @if(request()->routeIs('blog')) class="active" @endif href="{{route('blog')}}">Блог</a></li>
                <li><a @if(request()->routeIs('faq')) class="active" @endif href="{{route('faq')}}">Вопросы и ответы</a></li>
                <li><a @if(request()->routeIs('contacts')) class="active"
                       @endif href="{{route('contacts')}}">Контакт</a></li>
            </ul>
            <div class="menu d-lg-flex d-none">
                ...
                <a href="{{route('writeToDoctor')}}" class="appButton">НАПИСАТЬ ВРАЧУ</a>
            </div>
...
<section class="collapse navbar-collapse" id="navbarMenu">
    <ul class="nav navbar-nav p-2">
        ...
        <li><a href="{{route('treatmentProgram')}}">О программе лечения</a></li>
        <li><a href="{{route('abc')}}">Азбука наркомана</a></li>
        <li><a href="{{route('cases')}}">Кейсы лечения</a></li>
        <li><a href="{{route('requests')}}">Отзывы</a></li>
    </ul>
</section>
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <a href="tel:+7(011)2223344">+7 (011) 222 33 44</a>
            </div>
        </div>
    </div>
</section>
...
<footer>
    <div class="container">
        ...
        <ul>
            <li><a href="{{route('services')}}">Все услуги</a></li>
            <li><a href="{{route('cases')}}">Кейсы лечения</a></li>
        ...
        <ul>
            ...
            <li><a href="tel:+7 (011) 222 33 44">+7 (011) 222 33 44</a></li>
            <li><a href="#">г. Санкт-Петербург ул. Некрасова</a></li>
            <li><a href="mailto:nonarko@gmail.com">nonarko@gmail.com</a></li>
            <li class="social">
        ...
        <ul>
            <li><a class="logo" href="{{route('home')}}"><img src="{{asset('img/logo.svg')}}" alt="logo"></a></li>
            <li>
