...
@section('content')
    <div class="container blog">
        ...
        <div id="carousel-blog" class="carousel slide pointer-event app-carousel" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="d-flex flex-wrap flex-row justify-content-between">
                        <div class="block__item">
                            <img src="{{asset('img/dummy-image-350x250.gif')}}" data-src="{{asset('img/items/Rectangle.png')}}" alt="">
                            <div>
            ...
            <div class="d-flex justify-content-end align-items-center"><a class="carousel-control-prev"
                                                                          href="#carousel-blog" role="button"
                                                                          data-slide="prev">
