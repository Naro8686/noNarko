...
@section('content')
    <div class="container services">
        ...
        <div class="flexbox mt-100">
            ...
            <div class="box"><h1 class="mb-sm-5 mb-lg-0 mb-0">{{$service?$service->title:""}}</h1></div>
        </div>
        <div class="flexbox">
            <div class="box mb-5">
                @includeWhen(isset($parentCategory),'include.serviceCategories',['page' => $service])
            </div>
            @if(!is_null($service))
                <div class="box">
                    <div class="mt-lg-5 mt-0">{!! $service->body !!}</div>
                    @if($service->advantages()->exists())
                        <div class="mt-100 advantage-block">
                            ...
                            <ul class="flex-container">
                                @foreach($service->advantages()->get() as $advantage)
                    ...
                    @endif
                    @foreach($service->blog()->get() as $blog)
