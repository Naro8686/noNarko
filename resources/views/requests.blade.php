...
@section('content')
    <div class="container requests">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="request-item">
                            <div>
                                <img src="{{asset('img/dummy-image-350x250.gif')}}" data-src="{{asset('img/request/sad-lonely-woman-with-wavy-foxy-hair-touches-cheeks%202.png')}}"
                                     alt="">
                                <div>
        ...
        <form class="request-form mt-5 position-relative" data-count-cross="4">
            ...
            <div>
                ...
                <textarea class="mt-4" placeholder="Напишите отзыв" name="request" required="required"></textarea>
            </div>
            <div class="justify-content-between">
                <h1>
                    Проходили ли вы лечение?
                </h1>
